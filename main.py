...
# Function to load Morse code mappings
# Parameters:
...
# Keeps asking until the user provides a valid file name.
# Parameters:
...
def convert_morse_to_text(morse_lines, morse_mapping):
    ...
    for line in morse_lines:
        ...
        decoded_text += " "  # Add a space between words
...
def main():
    ...
    # Read the Morse code from the file
